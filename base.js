...
XWUZ.say = function () {
	return {
		alert: function (question) {
			...
			document.getElementById('alertbox_content').innerHTML = question + '<br style="clear:both" /><br /><a href="#" onclick="XWUZ.say.dismiss(); XWUZ.flow.restart();return false;"><img src="/i/b_okay.png" alt="Okay" /></a><a href="http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=331614220&mt=8"><img src="/i/appstore.png" alt="Available on the App Store" style="margin-top:20px;" /></a>';
		},
		confirm: function (question) {
			XWUZ.flow.pause();
			document.getElementById('alertbox').style.display = 'block';
			document.getElementById('alertbox_content').innerHTML = question + '<br style="clear:both" /><br /><a href="#" onclick="XWUZ.say.dismiss(); XWUZ.flow.restart();return false;"><img src="/i/b_yes.png" alt="Yes" /></a><a href="#" onclick="XWUZ.say.dismiss(); XWUZ.flow.resume(); return false;"><img src="/i/b_no.png" alt="No" /></a><a href="http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=331614220&mt=8"><img src="/i/appstore.png" alt="Available on the App Store" style="margin-top:40px;" /></a>';
		},
		dismiss: function () {
